...
This second version creates an abstract/interface class, from which two types of guitars inherit. The first one implements the abstract 
methods, but the second one has a composition of an adapter object that it will use within the abstract methods of the first one.*/
