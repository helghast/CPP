...
Init
================== */
Board::Board(Pieces *pPieces, const int pScreenHeight) 
	: mScreenHeight(pScreenHeight), /* Get the screen height */
	mPieces(mPieces) /* Get the pointer to the pieces class*/
{
...
====================================== */
void Board::StorePiece(const int pX, const int pY, const int pPiece, const int pRotation)
{
	// Store each block of the piece into the board
	const int pXBlocks = pX + PIECE_BLOCKS;
	const int pYBlocks = pY + PIECE_BLOCKS;
	for (int i1 = pX, i2 = 0; i1 < pXBlocks; ++i1, ++i2)
	{
		for (int j1 = pY, j2 = 0; j1 < pYBlocks; ++j1, ++j2)
		{	
...
====================================== */
int Board::GetXPosInPixels(const int pPos)
{
	return ((BOARD_POSITION - (BLOCK_SIZE * (HALF_BOARD_WIDTH))) + (pPos * BLOCK_SIZE));
}
...
>> pPos:	Horizontal position of the block in the board
====================================== */
int Board::GetYPosInPixels(const int pPos)
{
...
>> pRotation:	1 of the 4 possible rotations
====================================== */
bool Board::IsPossibleMovement(const int pX, const int pY, const int pPiece, const int pRotation)
{
